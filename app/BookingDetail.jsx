      ...
      case "pending":
        return (
          <View style={[styles.statusBadge, styles.badgePending]}>
            <Text style={[styles.statusText, styles.badgeTextPending]}>
              Pending
            </Text>
          </View>
        );
      ...
      case "active":
        return (
          <View style={[styles.statusBadge, styles.badgeActive]}>
            <Text style={[styles.statusText, styles.badgeTextActive]}>
              Active
            </Text>
          </View>
        );
      case "cancelled":
        return (
          <View style={[styles.statusBadge, styles.badgeCancelled]}>
            <Text style={[styles.statusText, styles.badgeTextCancelled]}>
              Cancelled
            </Text>
          </View>
        );
        ...
        <View style={styles.content}>
          ...
          <View style={styles.carCard}>
            <Text style={styles.carTitle}>
              {booking.car?.make?.name || "Unknown Make"}{" "}
              {booking.car?.model?.name || "Unknown Model"}
            </Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailLabel}>Booking ID: {booking.id}</Text>
            </View>
            <View style={styles.detailRow}>
              <FileText color="#0284C7" size={24} />
            ...
            <View style={styles.section}>
              ...
              {booking.inspections.map((inspection, index) => (
                <View
                  ...
                  style={{
                    marginBottom:
                      index < booking.inspections.length - 1 ? 24 : 0,
                  }}
                >
                  <Text
                    style={[
          ...
          <View style={styles.section}>
            ...
            <View style={styles.detailRow}>
              <FileText color="#0284C7" size={24} />
              <Text style={styles.detailLabel}>
                Total Amount: {booking.payment?.currency || "USD"}{" "}
            ...
            <View style={styles.detailRow}>
              <FileText color="#0284C7" size={24} />
              <Text style={styles.detailLabel}>
                Platform Fee: {booking.payment?.currency || "USD"}{" "}
                {booking.payment?.platformFee || "N/A"}
              </Text>
            </View>
            <View style={styles.detailRow}>
              <FileText color="#0284C7" size={24} />
              <Text style={styles.detailLabel}>
                Host Earnings: {booking.payment?.currency || "USD"}{" "}
                {booking.payment?.hostEarnings || "N/A"}
              </Text>
            </View>
            <View style={styles.detailRow}>
              <FileText color="#0284C7" size={24} />
